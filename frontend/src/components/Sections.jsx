      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-5">
        {stats.map((s) => (
          <div key={s.label} className="rounded-2xl bg-white border border-slate-200 p-6 text-center lift">
            ...
            <div className="mt-1 text-sm font-semibold text-brand-700">{s.label}</div>
  ...
  <section className="py-20 lg:py-28 bg-white">
    <div className="mx-auto max-w-7xl px-5 lg:px-8">
      <div className="text-center max-w-2xl mx-auto mb-14">
        <div className="text-sm font-semibold uppercase tracking-widest text-brand-700">Testimonials</div>
  ...
  <section className="py-20 lg:py-28 bg-slate-50/50">
    <div className="mx-auto max-w-7xl px-5 lg:px-8">
      <div className="text-center max-w-2xl mx-auto mb-12">
        <div className="text-sm font-semibold uppercase tracking-widest text-brand-700">Explore by location</div>
        <h2 className="font-display mt-3 text-4xl sm:text-5xl font-bold text-slate-900">
          ...
          >
            <div>
              <div className="flex items-center gap-2 text-slate-900 font-semibold">
                <MapPin className="h-4 w-4 text-brand-600" /> {l.city}
              </div>
            ...
            <ArrowUpRight className="h-4 w-4 text-slate-400 group-hover:text-brand-600 group-hover:-translate-y-0.5 group-hover:translate-x-0.5 transition-transform" />
          </a>
        ))}
      </div>
    </div>
