        ...
        <div className="grid lg:grid-cols-2 gap-14 items-center">
          ...
          <div>
            ...
            <h2 className="font-display mt-3 text-4xl sm:text-5xl font-bold text-slate-900">
              A match score you can <span className="text-emerald-600">actually trust.</span>
            </h2>
          ...
          <div className="relative">
            <div className="rounded-3xl border border-slate-200 bg-white shadow-xl shadow-emerald-500/5 p-6">
