...
export const CandidateCard = ({ c }) => (
  <div className="lift rounded-2xl border border-slate-200 bg-white p-5 text-center relative overflow-hidden">
    <div className="absolute top-3 right-3 flex items-center gap-1 bg-emerald-50 text-emerald-700 rounded-full px-2 py-1 text-xs font-semibold">
      {c.match}% match
    </div>
    ...
    <div className="mt-5 flex gap-2">
      ...
      <Button size="sm" className="flex-1 bg-emerald-600 hover:bg-emerald-700 rounded-full">
        Invite
      </Button>
    </div>
  </div>
