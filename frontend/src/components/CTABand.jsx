  ...
  <section className="py-20">
    <div className="mx-auto max-w-7xl px-5 lg:px-8">
      <div className="relative overflow-hidden rounded-3xl bg-slate-900 p-10 lg:p-16">
        <div className="absolute -top-32 -right-24 w-96 h-96 rounded-full bg-brand-500/20 blur-3xl" />
        <div className="absolute -bottom-24 -left-24 w-80 h-80 rounded-full bg-brand-400/10 blur-3xl" />
        ...
        <div className="relative grid lg:grid-cols-2 gap-8 items-center">
          <div className="text-white">
            ...
            <h2 className="font-display mt-4 text-4xl sm:text-5xl font-bold leading-tight">
              Meet your next hire — <span className="text-brand-400">or next role.</span>
            </h2>
          ...
          <div className="flex flex-col sm:flex-row gap-3 lg:justify-end">
            <Link to="/jobs">
              <Button size="lg" className="bg-brand-500 hover:bg-brand-400 text-slate-900 rounded-full px-7 font-semibold w-full sm:w-auto">
