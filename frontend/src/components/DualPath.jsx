      ...
      <div className="mx-auto max-w-7xl px-5 lg:px-8">
        <div className="text-center max-w-2xl mx-auto mb-14">
          ...
          <h2 className="font-display mt-3 text-4xl sm:text-5xl font-bold text-slate-900">
            Built for candidates <span className="text-emerald-600">and</span> employers.
          </h2>
        </div>

        <div className="grid lg:grid-cols-2 gap-6">
          {/* Candidates */}
          <div className="relative rounded-3xl border border-slate-200 bg-gradient-to-br from-emerald-50/60 to-white p-8 lg:p-10 overflow-hidden">
            <div className="absolute -top-16 -right-16 w-64 h-64 rounded-full bg-emerald-100/60 blur-2xl pointer-events-none" />
            <div className="relative">
              <div className="inline-flex items-center gap-2 rounded-full bg-white border border-emerald-200 px-3 py-1 text-xs font-semibold text-emerald-700">
            ...
            <div className="relative">
              ...
              <div className="mt-8 space-y-4">
                {howItWorks.employers.map((s) => (
                  <div key={s.step} className="flex gap-4">
                    <div className="h-10 w-10 shrink-0 rounded-xl bg-emerald-500 text-slate-900 flex items-center justify-center font-bold text-sm">
                      {s.step}
                    </div>
                    <div>
              ...
              <div className="mt-8 flex flex-wrap items-center gap-3">
                <Link to="/candidates">
                  <Button className="bg-emerald-500 hover:bg-emerald-400 text-slate-900 rounded-full px-6 font-semibold">
