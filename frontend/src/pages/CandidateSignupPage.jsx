        ...
        <div className="mx-auto max-w-4xl px-5 lg:px-8 grid lg:grid-cols-[220px_1fr] gap-8">
          ...
          <div className="rounded-3xl border border-slate-200 bg-white p-6 lg:p-8">
            ...
            <div className="mt-8 flex items-center justify-between border-t border-slate-100 pt-5">
              ...
              {step < STEPS.length - 1 ? (
                <Button onClick={next} className="bg-emerald-600 hover:bg-emerald-700 rounded-full px-6">
        ...
        <div className="flex items-center gap-3 rounded-lg border border-slate-200 h-11 px-3">
          <button
            ...
            className={`h-5 w-9 rounded-full relative transition-colors ${
              form.openToWork ? "bg-emerald-500" : "bg-slate-300"
            }`}
          >
            <span
    ...
    <div className="space-y-5">
      <Field label="Upload your resume (optional)" hint="PDF or DOCX. Our AI will extract skills automatically.">
        <label className="block cursor-pointer">
          <div className="rounded-2xl border-2 border-dashed border-slate-300 hover:border-emerald-400 transition-colors p-6 text-center">
            {form.resumeFileName ? (
      ...
      <label className="flex items-start gap-3 cursor-pointer">
        ...
        <span className="text-sm text-slate-700">
          I agree to Vizarto's <a href="#" className="text-emerald-700 underline">Terms</a> and{" "}
          <a href="#" className="text-emerald-700 underline">Privacy Policy</a>.
        </span>
      </label>
